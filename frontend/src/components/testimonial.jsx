...
export default function Testimony({name, role, text}) {
    return (
                <motion.div 
        variants={FadeItem}
        className="w-full lg:w-full lg:m-3 bg-gray-200 h-auto mb-5 relative p-3 text-left lg:p-5 rounded-tl-3xl rounded-br-3xl border-b-2 border-double border-yellow-500">
