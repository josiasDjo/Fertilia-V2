...
export function Input({icon, type, placeholder, name, id}) {
    return (
        <motion.div variants={FadeItem} className="rounded-3xl p-2 px-4 border-2 border-solid border-black border-opacity-10 mb-3 shadow-lg focus:outline-none focus:ring-2 focus:ring-bg-yellow-400 focus:ring-opacity-50">
