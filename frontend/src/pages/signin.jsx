...
export function Signin () {
    return <>
        <div id="signin" className="flex shadow-xl w-full h-screen backdrop-blur-md bg-white rounded-3xl lg:flex-row relative">
            <div className="flex flex-col w-full lg:w-6/12 lg:px-16 py-3 md:py-4 justify-center items-center relative">
