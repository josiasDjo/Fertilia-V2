...
export default function NavBarDash() {
    return (
        <nav class="relative h-16 w-full lg:w-[calc(100%-16rem)] m-3 lg:ml-6 px-5 shadow-lg flex flex-row justify-between items-center bg-white dark:bg-gray-700 rounded-lg
